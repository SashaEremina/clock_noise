...
cd(['C:\Users\sasha.eremina\Documents\MATLAB\clock_robust_fig\datasets_for_plotting\caribbean_1']);
...
int=readmatrix('10-Aug-2022_WT_light_intensity.csv'); %need to re-upload the light with subtraction!
int=int-min(int); %for now, using a manual subtraction

time_light2=readmatrix('10-Aug-2022_WT_time_light_adjusted.csv');
...
yticklabels({'0','15','30','45','60','75'}); %approx
ax = gca;
ax.YColor='k';
...
hold on; 
h(2)=plot(time_adjusted(st:end,20),MY_smooth(st:end,20),'m','LineWidth',2,'DisplayName','Representative lineage'); %'WT individual lineage'
