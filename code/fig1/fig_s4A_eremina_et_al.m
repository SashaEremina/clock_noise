...
hold on; f(3)=plot(t,inst_amplitude,'DisplayName','amplitude ({\ita(t)})','LineWidth',1,'Color',colorblind(ii,:)); ii=ii+1;

hold on; f(4)=plot(t,MY_tn,'DisplayName','fluorescence ({\itx(t)})','LineWidth',1,'Color',colorblind(ii,:)); ii=ii+1;
