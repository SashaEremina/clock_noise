...
titles = {'WT','\it\DeltaldpA', '\it\Deltapex', '\it\DeltaprkE','\it\DeltalalA'};  
...
subplot(5,2,4); h(1)=histogram(w1,'Normalization', 'probability'); hold on; xticks(0:50:200); xlim([0 200]); yticks(0:0.25:0.5); ylim ([0 0.4]); text(0.6,0.6,'\it\DeltaldpA','Units','normalized'); 
subplot(5,2,6); h(2)=histogram(w2,'Normalization', 'probability'); hold on; xticks(0:50:200); xlim([0 200]); yticks(0:0.25:0.5); ylim ([0 0.4]); text(0.6,0.6,'\it\Deltapex','Units','normalized'); 
subplot(5,2,8); h(3)=histogram(w3,'Normalization', 'probability'); hold on; xticks(0:50:200); xlim([0 200]); yticks(0:0.25:0.5); ylim ([0 0.4]); text(0.6,0.6,'\it\DeltaprkE','Units','normalized'); 
subplot(5,2,10); h(4)=histogram(w4,'Normalization', 'probability'); hold on; xticks(0:50:200); xlim([0 200]); yticks(0:0.25:0.5); ylim ([0 0.4]); text(0.6,0.6,'\it\DeltalalA','Units','normalized'); 
...
figure(1); hold on; 
subplot(5,2,1); h(5)=histogram(w5,'Normalization', 'probability'); hold on; yticks(0:0.25:0.25); xticks(0:750:2250); xlim([0 2250]); ylim ([0 0.45])
subplot(5,2,3); h(1)=histogram(w1,'Normalization', 'probability'); hold on; yticks(0:0.25:0.25); xticks(0:750:2250); xlim([0 2250]); ylim ([0 0.45])
subplot(5,2,5); h(2)=histogram(w2,'Normalization', 'probability'); hold on; yticks(0:0.25:0.25); xticks(0:750:2250); xlim([0 2250]); ylim ([0 0.45])
subplot(5,2,7); h(3)=histogram(w3,'Normalization', 'probability'); hold on; yticks(0:0.25:0.25); xticks(0:750:2250); xlim([0 2250]); ylim ([0 0.45])
subplot(5,2,9); h(4)=histogram(w4,'Normalization', 'probability'); hold on; yticks(0:0.25:0.25); xticks(0:750:2250); xlim([0 2250]); ylim ([0 0.45])
...
han.YLabel.Position(1)=han.YLabel.Position(1)*1.8;

%% Saving - disabled
cd([selpath,'/figures/fig2']);
fname='fig_s8';
fig_save_font_16_ssf;